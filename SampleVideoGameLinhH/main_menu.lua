...
local bkg_image = display.newImageRect("Images/bkg_image.jpg", 2000, 2100)
local playButton
local creditsButton
...
-- Creating Transition to Instructions Page
 ...
 local function InstructionsTransition( )
    composer.gotoScene( "instructions_screen", {effect = "slideUp", time = 500})
end   
-----------------------------------------------------------------------------------------
...
function scene:create( event )
    ...
    bkg_image = display.newImage("Images/bkg_image.jpg")
